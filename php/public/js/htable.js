    ...
    create: function (id, hack) {
        ...
        t.render = function () {
            ...
            if ((scrollPanelHeight + t.additionHeight) <= root.height()) {
                ...
                t.root.append("<div class='border-shadow'></div>");
            }
            ...
            t.grandfather.scroll(function () {
                ...
                if (st > 0) {
                    ...
                    if (!t.grandfather.scrollAnimate && !t.grandfather.up && $(this).children().first().height() - st - $(this).height() < 20) {
                        //console.debug(st + $(this).height());
                        //$(this).animate({borderBottomWidth:"10px"}, 100).animate({borderBottomWidth:"1px"},1000);
                        t.grandfather.scrollAnimate = true;
                        t.root.find(".border-shadow:first").animate({opacity: .4});
                        window.setTimeout(function () {
                            t.root.find(".border-shadow:first").animate({opacity: 0});
                        }, 300);
                    }
...
//
//            d1.append(d2);
//            d1.height(root.height());
//            d1.width(root.width() - t.fixTable.width());
//            d2.width(t.scrollTable.width());
//            d2.height(t.scrollTable.height());
//
//            root.parent().height(root.height() + foot.scrollTable.height());
//
//            d1.css("position", "absolute");
//            d1.css("top", 0);
//            d1.css("right", 0);
//            d1.appendTo(root.parent());
//            d1.css("-webkit-overflow-scrolling", "touch");
//            d1.css("border", "1px solid red");
//
//            d1.css("overflow-x", "scroll");
//
//            d1.scroll(function () {
//
//                var target = $(this);
...
//
//                if (sl > 10) {
//                    t.floatScrollTableTitlePanel.animate({scrollLeft: sl + 'px'}, 0);
//                    t.scrollTable.parent().scrollLeft(sl);
//                    if (t.footTable) {
//                        t.footTable.scrollTable.parent().animate({scrollLeft: sl + 'px'}, 0);
//                    }
//                }
//
//                var st = target.scrollTop();
//                if (st > 10)
//                    t.grandfather.scrollTop(st);
//
//            });
            ...
            for (var i = 0; i < columns.length; i++) {
                ...
                for (var j = 0; j < columns[i].length; j++) {
                    ...
                    if ("click" in fieldOption) {
                        t.scrollTable.click({clickFun: fieldOption["click"], field: field, fieldIndex: j}, function (e) {
